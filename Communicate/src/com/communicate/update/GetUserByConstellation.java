...
public class GetUserByConstellation {
private List<PeopleItem> list ;
	
	public List<PeopleItem> getUserByConstellation(String constellation){
		...
		try{
			...
			String query=("SELECT * FROM `us_er` WHERE `constellation` ='" + constellation + "'");// 创造SQL语句 
			...
			while(rs.next())
			{
		        ...
		        String constellation2 = rs.getString("constellation");
		        ...
		        peopleItem.setConstellation(constellation2);
		        if(signature != null)
