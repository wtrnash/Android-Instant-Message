...
public class GetUserByEducation {
private List<PeopleItem> list ;
	
	public List<PeopleItem> getUserByEducation(String education){
		...
		try{
			...
			String query=("SELECT * FROM `us_er` WHERE `education` ='" + education + "'");// 创造SQL语句 
			...
			while(rs.next())
			{
		        ...
		        String education2 = rs.getString("education");
		        ...
		        peopleItem.setEducation(education2);
